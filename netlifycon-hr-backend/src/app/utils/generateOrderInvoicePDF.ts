	...
	<div class="page">
		...
		<div class="content">
			...
			<p>We look forward to mutually rewarding term with us.</p>
			 ...
			 <div class="stamp">
    <img src="./logo.png" alt="Company Stamp" />
  </div>



			<p><strong>Regards,</strong><br />
				 ${offerLetter.companyContactName} | ${offerLetter.companyPersonTitle}<br />
				Woodrock Softonic Private Limited<br />
				Mail: <a href="mailto:Simran.jha@woodrockgroup.in">${offerLetter.employeeEmail}</a>
			</p>
		</div>
	</div>
